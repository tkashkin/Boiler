...
using Boiler.Application.UI.Views;
using Boiler.Application.UI.Views.Connect;

namespace Boiler.Application.UI.Windows
{
	public class MainWindow: Gtk.Dialog
	{
		...
		public MainWindow(Boiler.Application.Application app)
		{
			Object(
				application: app,
				icon_name: Config.PROJECT_NAME,
				resizable: false,
				title: _("Boiler"),
